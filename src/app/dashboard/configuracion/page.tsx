      ...
      <div className="space-y-5 p-5">
        ...
        <div className="grid gap-5 xl:grid-cols-2">
          <section className="rounded-lg border border-slate-200 bg-white p-5">
            ...
            <p className="mt-1 text-sm leading-6 text-slate-500">Crea un acceso con permisos completos para otro miembro del equipo.</p>
            <form className="mt-5 space-y-4" onSubmit={handleInvite}>
              ...
              <ActionButton type="submit">Crear acceso</ActionButton>
            </form>
          </section>
